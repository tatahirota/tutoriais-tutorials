# **INSTALAÇÃO DO DEBIAN NA VIRTUALBOX**    
# **DEBIAN VIRTUALBOX INSTALLATION**

<br>   

## **1- DOWNLOAD DO DEBIAN NO SITE.**  
## **1- DOWNLOAD DEBIAN ON THE WEBSITE.** 
...
## **3- WHEN THE WINDOW TO CREATE THE VIRTUAL MACHINE OPENS, FILL IN THE FIELDS.**
...
Folder (F): where the Debian VM will be installed (probaly in the folder where the VM is located).   
Type: Linux.    
Subtype: Debian.    
...
## **4- FILL IN THE FIELDS OF "Unattended Installation (U)".**
...
USER AND PASSWORD:   
Username: whatever you prefer.   
Password (W): whatever you prefer. Tip: with at least 8 characteres, including symbols, numbers, uppercase and lowercase letters.   
Repeat Password:    

ADDITIONAL OPTIONS:    
Host (H): whatever you prefer.    
Domain Name: myguest.virtualbox.org . You can leave for local testing or change it later.    
<br>   
...
## **5- FILL IN THE FIELDS UNDER "Hardware":**   
...
<br>    
Base Memory: 2gb shoul be enough for small tests.   
Processors: 2 CPUs should also be enough for small tests.   
<br>  
...
## **6- SELECT THE DESIRED AMOUNT OF VIRTUAL DISK. FOR SIMPLE TEST, 30gb SHOULD BE ENOUGH. AFTER THAT, CLICK ON "Finish".** 
<br>       
...
## **7- A VM IRÁ INICIAR AUTOMATICAMENTE PARA A INSTALAÇÃO DO SISTEMA. PARA FACILITAR, ESCOLHA A INTERFACE GRÁFICA DO DEBIAN, SE ESTIVER ESSA OPÇÃO.**
## **7- THE VM WILL START AUTOMATICALLY FOR THE SYSTEM INSTALLATION. TO MAKE IT EASIER, CHOOSE THE GRAPHICAL INTERFACE OF DEBIAN, IF THAT OPTION IS AVAILABLE.**  
<br>     
...
## **8- INSTALLING DEBIAN. IN MY CASE, THERE WAS NO OPTION FOR THE GRAPHICAL INTERFACE.**   
<br>    
...
## **9- INSTALLATION COMPLETED! LOGIN STAGE.**  
<br>     
...
## **10- DONE! YOU ARE NOW ON THE DEBIAN DESKTOP IN VIRTUALBOX! 😊**   
<br>   
